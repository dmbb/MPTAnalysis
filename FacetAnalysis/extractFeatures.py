...
def FeatureExtractionBiGramBenchmark(sampleFolder):
    ...
    for sample in os.listdir(sampleFolder):
        ...
        #print np.array(bigram_list).nbytes
        #np.save("FacetTraffic_Web_1000/240Resolution/records/" + sample+ "_list", np.array(bigram_list))
...
def FeatureExtractionStatsBenchmark(sampleFolder):
    ...
    for sample in os.listdir(sampleFolder):
        ...
        #np.save("FacetTraffic_Web_1000/240Resolution/records/" + sample+ "_list", np.array(bin_list))
        label = os.path.basename(sampleFolder)
        if('Regular' in sampleFolder):
            label = 'Regular'
...
def FeatureExtractionPLBenchmark(sampleFolder):
    #Bin width for feature generation is set to 5. This can be changed, but the automatically
    # generated feature sets names do not currently reflect possible changes.
...
if __name__ == "__main__":
    sampleFolders = [
    "TrafficCaptures/240Resolution/FacetTraffic_12.5_Christmas",
    "TrafficCaptures/240Resolution/FacetTraffic_25_Christmas",
    "TrafficCaptures/240Resolution/FacetTraffic_50_Christmas",
    "TrafficCaptures/240Resolution/RegularTraffic_Christmas",
    ]
